const QUESTIONS = [
  ...
  // ══ Bloc 11 — 📝 Examen — type prof ══
  {
    ...
    correct: [1],
    feedback: "Loi de Ricco : pour de petites surfaces de lumière, l'intensité (radiance) requise pour la détection est inversement proportionnelle à la surface, lorsque la durée est fixe (I × Surface = constante, jusqu'à l'« aire de Ricco »). À distinguer de : l'échange intensité/durée (loi de Bloch), le changement de teinte avec l'énergie (Bezold-Brücke), et la croissance logarithmique de la sensation (loi de Fechner)."
  },
  {
  ...
  },
  {
    ...
    correct: [3, 0],
    feedback: "Bezold-Brücke : à énergie croissante, le rouge est perçu plus jaune et le violet plus bleu (la teinte perçue dépend de l'intensité). À ne pas confondre avec la couleur bleue du ciel (diffusion de Rayleigh) ni avec la relation logarithmique sensation/intensité (loi de Fechner)."
  },
  {
  ...
  },
  {
    ...
    correct: [0, 1],
    feedback: "Diffusion de Rayleigh : soleil haut → trajet court → ciel bleu ; soleil bas → trajet long → lumière bleue perdue → ciel rouge/orangé. À distinguer du changement de teinte perçue avec l'énergie (Bezold-Brücke) et de la décomposition d'un son en partiels (sensation auditive, Helmholtz)."
  },
  {
